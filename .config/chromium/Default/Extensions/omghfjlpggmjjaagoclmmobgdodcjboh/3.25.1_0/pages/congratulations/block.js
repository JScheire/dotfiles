define(["exports"], function (_exports) {
  ...
  */
  ...
  function render$3() {
    return html(_templateObject_7defcdc0e12811e9872675d52dfcba91(), this.mainLink, translations.activated, translations.surfingSecured, translations.clickToolbarIconAndTurnOn, translations.getMoreWithPremium, translations.premiumLocations, translations.accessPremiumLocations, translations.turboSpeed, translations.dedicatedLanes, translations.premiumServers, translations.performanceGuaranteed, this.premiumLink, translations.checkPremiumPlans);
  }
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(MainBlock, [{
      ...
      // Properties
      get: function get() {
        if (!this.pageLinks.base) return '';
        return this.browsecLink(this.pageLinks.base, function (search) {
      ...
      key: "premiumLink",
      get: function get() {
        if (!this.pageLinks.premium) return '';
        return this.browsecLink(this.pageLinks.premium, function (search) {
          return Object.assign(search, {
            'utm_source': 'Chromium extension',
    ...
    function MainBlock() {
      ...
      _this11 = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(MainBlock).call(this));
      _this11.pageLinks = {};
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                /** @method */
                _this11.browsecLink = function (url
                /*: string*/
                )
                /*: string*/
                {
              ...
              case 6:
                _this11.pageLinks = _context2.sent;
