...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return onMessage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return sendMessage; });
...
var _defaultFormatter = __webpack_require__(115);

var _defaultFormatter2 = _interopRequireDefault(_defaultFormatter);

var _dateParser = __webpack_require__(116);
...
var k=__webpack_require__(94),n="function"===typeof Symbol&&Symbol.for,p=n?Symbol.for("react.element"):60103,q=n?Symbol.for("react.portal"):60106,r=n?Symbol.for("react.fragment"):60107,t=n?Symbol.for("react.strict_mode"):60108,u=n?Symbol.for("react.profiler"):60114,v=n?Symbol.for("react.provider"):60109,w=n?Symbol.for("react.context"):60110,x=n?Symbol.for("react.concurrent_mode"):60111,y=n?Symbol.for("react.forward_ref"):60112,z=n?Symbol.for("react.suspense"):60113,aa=n?Symbol.for("react.memo"):
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(94),r=__webpack_require__(110);function ba(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[c,d,e,f,g,h],k=0;a=Error(b.replace(/%s/g,function(){return l[k++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
var warning_warning = __webpack_require__(34);
...
var invariant_browser = __webpack_require__(86);
...
var hoist_non_react_statics_cjs = __webpack_require__(101);
var hoist_non_react_statics_cjs_default = /*#__PURE__*/__webpack_require__.n(hoist_non_react_statics_cjs);

// EXTERNAL MODULE: ./node_modules/path-to-regexp/index.js
var path_to_regexp = __webpack_require__(89);
...
// EXTERNAL MODULE: ./src/scss/pia.scss
var pia = __webpack_require__(91);

// CONCATENATED MODULE: ./src/jsx/contexts/AppContext.js

const AppContext_context = {
  app: {},
  theme: 'dark',
  updateTheme: () => {}
};
const AppContext = Object(react["createContext"])(AppContext_context);
...
// CONCATENATED MODULE: ./src/jsx/hoc/listenOnline.jsx
function listenOnline_extends() { listenOnline_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return listenOnline_extends.apply(this, arguments); }
...
function listenOnline(NestedComponent) {
  class OnlineListener extends react["Component"] {
    constructor(props) {
      super(props); // bindings

      this.handleNetworkStatusChange = this.handleNetworkStatusChange.bind(this); // state

      this.state = {
        online: OnlineListener.getOnlineStatus()
      };
    }
    ...
    render() {
      ...
      return react_default.a.createElement(NestedComponent, listenOnline_extends({
        online: online
      }, this.props));
    }
...
/* harmony default export */ var hoc_listenOnline = (listenOnline);
// CONCATENATED MODULE: ./src/jsx/component/Switch.jsx



const component_Switch_Switch = props => {
  const {
    mode,
    theme,
    classes,
    connection,
    onToggleConnection
  } = props; // noop if connection is 'error'
...
component_Switch_Switch.propTypes = {
  classes: prop_types_default.a.string,
  mode: prop_types_default.a.string.isRequired,
  theme: prop_types_default.a.string.isRequired,
  connection: prop_types_default.a.string.isRequired,
  onToggleConnection: prop_types_default.a.func.isRequired
};
component_Switch_Switch.defaultProps = {
  classes: ''
};
/* harmony default export */ var component_Switch = (component_Switch_Switch);
// CONCATENATED MODULE: ./src/jsx/component/LoginField.jsx
...
const LoginField = ({
  ...
  return react_default.a.createElement("input", {
    ...
    className: `login-input ${theme}` // If an autofocus action can be anticipated, it
...
LoginField.propTypes = {
  ...
  theme: prop_types_default.a.string.isRequired,
  localeKey: prop_types_default.a.string.isRequired,
...
/* harmony default export */ var component_LoginField = (LoginField);
// CONCATENATED MODULE: ./src/jsx/hoc/withAppContext.jsx
function withAppContext_extends() { withAppContext_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return withAppContext_extends.apply(this, arguments); }
...
function withAppContext(ChildComponent) {
  function injector(props) {
    return react_default.a.createElement(AppConsumer, null, context => {
      return react_default.a.createElement(ChildComponent, withAppContext_extends({
        context: context
      }, props));
    });
  }
...
/* harmony default export */ var hoc_withAppContext = (withAppContext);
// CONCATENATED MODULE: ./src/jsx/component/Tooltip.jsx
...
const Tooltip = ({
  ...
  return react_default.a.createElement("div", {
    className: `popover arrow-${orientation} ${theme}`
  }, message);
};

Tooltip.propTypes = {
  orientation: prop_types_default.a.string,
  theme: prop_types_default.a.string.isRequired,
...
/* harmony default export */ var component_Tooltip = (Tooltip);
// CONCATENATED MODULE: ./src/jsx/hoc/errorboundary.jsx
...
const createErrorBoundary = ReactClass => {
  return class ErrorBoundary extends react["Component"] {
    ...
    render() {
      ...
      return react_default.a.createElement(ReactClass, this.props);
    }

  };
};

/* harmony default export */ var errorboundary = (createErrorBoundary);
// CONCATENATED MODULE: ./src/jsx/component/checkbox/index.jsx
...
const Checkbox = props => {
  ...
  return react_default.a.createElement("div", {
    className: buildClassName('container', id, className)
  }, react_default.a.createElement("input", {
    id: id,
    name: id,
    onChange: onChange,
    className: buildClassName('input', id, ...(disabled ? ['disabled'] : [])),
    type: "checkbox",
    checked: checked,
    disabled: disabled
...
/* harmony default export */ var component_checkbox = (errorboundary(Checkbox));
// CONCATENATED MODULE: ./src/jsx/component/checkbox/UncontrolledCheckbox.jsx
...
class UncontrolledCheckbox_UncontrolledCheckbox extends react["Component"] {
  constructor(props) {
  ...
  render() {
    ...
    return react_default.a.createElement(component_checkbox, {
      id: id,
      theme: theme,
      checked: checked,
      className: className,
...
UncontrolledCheckbox_UncontrolledCheckbox.propTypes = {
  className: prop_types_default.a.string,
...
UncontrolledCheckbox_UncontrolledCheckbox.defaultProps = {
  className: '',
  defaultChecked: false
};
/* harmony default export */ var checkbox_UncontrolledCheckbox = (hoc_withAppContext(UncontrolledCheckbox_UncontrolledCheckbox));
// CONCATENATED MODULE: ./src/jsx/component/checkbox/RememberMeCheckbox.jsx
...
class RememberMeCheckbox_RememberMeCheckbox extends react["Component"] {
  constructor(props) {
    super(props); // properties
    ...
    this.rememberMe = this.settings.getItem('rememberme'); // Bindings
  ...
  render() {
    ...
    }, react_default.a.createElement(checkbox_UncontrolledCheckbox, {
    ...
    }, t(labelLocaleKey)), react_default.a.createElement(component_Tooltip, {
      theme: theme,
      orientation: "right",
...
RememberMeCheckbox_RememberMeCheckbox.propTypes = {
  context: prop_types_default.a.object.isRequired,
  labelLocaleKey: prop_types_default.a.string.isRequired
};
/* harmony default export */ var checkbox_RememberMeCheckbox = (hoc_withAppContext(RememberMeCheckbox_RememberMeCheckbox));
// CONCATENATED MODULE: ./src/jsx/component/LoginForm.jsx
...
class LoginForm_LoginForm extends react["Component"] {
  constructor(props) {
    super(props); // properties
  ...
  handleSubmit(event) {
    ...
    const {
      username,
      password
    } = this.state; // try to authenticate user

    this.user.auth(username, password).then(() => {
      this.history.push('/');
    }).catch(res => {
      let errorText = '';
      this.setState({
      ...
      switch (res.cause) {
        ...
        case 'status':
          {
            ...
            if (status === 401) {
              errorText = t('WrongUsernameAndPassword');
            } else if (status === 429) {
              errorText = t('TooManyRequestsError');
            } else {
              errorText = t('UnexpectedServerResponse', {
        ...
        case 'timeout':
          {
            errorText = t('TimeoutError', {
              seconds: this.user.authTimeout / 1000
            });
            break;
          }
  ...
  render() {
    ...
    return react_default.a.createElement("form", {
      ...
      className: `text-danger ${errorText ? '' : 'hidden'}`
    }, errorText), react_default.a.createElement(component_LoginField, {
      type: "text",
      theme: theme,
      name: "username",
      autoFocus: true,
    ...
    }), react_default.a.createElement(component_LoginField, {
      theme: theme,
      type: "password",
      name: "password",
      autocomplete: "off",
    ...
    }), react_default.a.createElement(checkbox_RememberMeCheckbox, {
      labelLocaleKey: "RememberMe"
    }), react_default.a.createElement("button", {
      type: "submit",
      className: "btn btn-submit"
    }, react_default.a.createElement("span", {
      className: `submit-text ${loading ? 'hidden' : ''}`
    }, t('LoginText')), react_default.a.createElement("div", {
      className: `loader ${loading ? '' : 'hidden'}`
    }, react_default.a.createElement(component_Switch, {
      theme: theme,
      mode: "connecting",
...
LoginForm_LoginForm.propTypes = {
  context: prop_types_default.a.object.isRequired,
  history: prop_types_default.a.object.isRequired
};
/* harmony default export */ var component_LoginForm = (react_router_dom_es_withRouter(hoc_withAppContext(LoginForm_LoginForm)));
// CONCATENATED MODULE: ./src/jsx/component/MoreLinks.jsx
...
class MoreLinks_MoreLinks extends react["Component"] {
  constructor(props) {
    super(props); // properties
  ...
  render() {
    ...
    return react_default.a.createElement("div", {
      className: "more-links-container noselect"
    }, react_default.a.createElement("div", {
      role: "button",
      tabIndex: "-1",
    ...
    }, ".", react_default.a.createElement("br", null), ".", react_default.a.createElement("br", null), ".", react_default.a.createElement("br", null)), react_default.a.createElement("div", {
      className: `more-links-dropdown ${open ? 'open' : ''}`
    }, react_default.a.createElement("ul", null, react_default.a.createElement("li", null, react_default.a.createElement("div", {
      role: "button",
      tabIndex: "-1",
      className: `${this.user.getLoggedIn() ? '' : 'disabled'}`,
      onClick: this.openSettings,
      onKeyPress: this.openSettings
    }, t('ChangeExtensionSettings'))), react_default.a.createElement("li", null, react_default.a.createElement("div", {
      role: "button",
      tabIndex: "-1",
      className: `${online ? '' : 'disabled'}`,
      onClick: this.openAccount,
      onKeyPress: this.openAccount
    }, t('AccountSettingsText'))), react_default.a.createElement("li", null, react_default.a.createElement("div", {
      role: "button",
      tabIndex: "-1",
      className: `${online ? '' : 'disabled'}`,
      onClick: this.openSupport,
      onKeyPress: this.openSupport
    }, t('SupportText'))), react_default.a.createElement("li", null, react_default.a.createElement("div", {
      role: "button",
      tabIndex: "-1",
      className: `${this.user.getLoggedIn() ? '' : 'disabled'}`,
      onClick: this.logout,
...
MoreLinks_MoreLinks.propTypes = {
  online: prop_types_default.a.bool.isRequired,
  context: prop_types_default.a.object.isRequired,
  history: prop_types_default.a.object.isRequired
};
/* harmony default export */ var component_MoreLinks = (hoc_listenOnline(react_router_dom_es_withRouter(hoc_withAppContext(MoreLinks_MoreLinks))));
// CONCATENATED MODULE: ./src/jsx/component/CompanyLogo.jsx





class CompanyLogo_CompanyLogo extends react["Component"] {
  constructor(props) {
    super(props); // properties
  ...
  render() {
    ...
    } = this.props; // Normal Case: turn on and off proxy connection

    let content = '';

    if (mode === 'connecting' && connection === 'connected') {
      content = t('Disconnecting');
    } else if (mode === 'connecting' && connection === 'disconnected') {
    ...
    return react_default.a.createElement("div", {
      className: `company-logo ${mode} ${theme} ${connection} ${offlineClass}`
    }, react_default.a.createElement("div", {
      className: "connected-gradient"
    }, t('Connected')), react_default.a.createElement("div", {
      className: "display-content"
    }, react_default.a.createElement("div", {
      className: "display-left"
    }), react_default.a.createElement("div", {
      className: "display-middle"
    }, content), react_default.a.createElement("div", {
      className: "display-right"
    }, hideLinks ? '' : react_default.a.createElement(component_MoreLinks, null))));
  }

}

CompanyLogo_CompanyLogo.propTypes = {
  mode: prop_types_default.a.string,
  error: prop_types_default.a.string,
  hideLinks: prop_types_default.a.bool,
  connection: prop_types_default.a.string,
  context: prop_types_default.a.object.isRequired
};
CompanyLogo_CompanyLogo.defaultProps = {
  mode: '',
  error: '',
  connection: '',
  hideLinks: false
};
/* harmony default export */ var component_CompanyLogo = (hoc_withAppContext(CompanyLogo_CompanyLogo));
// CONCATENATED MODULE: ./src/jsx/pages/LoginPage.jsx
...
class LoginPage_LoginPage extends react["Component"] {
  constructor(props) {
    super(props); // properties

    this.app = props.context.app;
    this.i18n = this.app.util.i18n;
    this.settings = this.app.util.settings; // bindings
  ...
  render() {
    ...
    return react_default.a.createElement("div", {
      id: "login-page",
      className: `row ${theme}`
    }, react_default.a.createElement(component_CompanyLogo, {
      hideLinks: true
    }), react_default.a.createElement(component_LoginForm, null), react_default.a.createElement("div", {
    ...
    }, t('ForgotPassword')), react_default.a.createElement("a", {
      target: "_blank",
...
LoginPage_LoginPage.propTypes = {
  online: prop_types_default.a.bool.isRequired,
  context: prop_types_default.a.object.isRequired
};
/* harmony default export */ var pages_LoginPage = (hoc_withAppContext(hoc_listenOnline(LoginPage_LoginPage)));
// CONCATENATED MODULE: ./src/jsx/pages/UpgradePage.jsx





class UpgradePage_UpgradePage extends react["Component"] {
  constructor(props) {
    super(props); // properties
  ...
  render() {
    ...
    return react_default.a.createElement("div", {
      className: `chrome-upgrade-page row ${theme}`
    }, react_default.a.createElement(component_CompanyLogo, {
      hideLinks: true
    }), react_default.a.createElement("div", {
      ...
      browser: this.buildinfo.browser
    })), react_default.a.createElement("p", {
...
UpgradePage_UpgradePage.propTypes = {
  context: prop_types_default.a.object.isRequired
};
/* harmony default export */ var pages_UpgradePage = (hoc_withAppContext(UpgradePage_UpgradePage));
// CONCATENATED MODULE: ./src/jsx/component/PageTitle.jsx
...
class PageTitle_PageTitle extends react["Component"] {
  constructor(props) {
    super(props); // properties

    this.app = props.context.app;
    this.history = props.history; // bindings
  ...
  render() {
    ...
    let content = text; // Offline Case: display no network warning above all else
    ...
    return react_default.a.createElement("div", {
      className: `header ${theme} ${offlineClass}`
    }, react_default.a.createElement("div", {
      role: "button",
      tabIndex: "-1",
      className: "back-icon",
...
/* harmony default export */ var component_PageTitle = (hoc_listenOnline(react_router_dom_es_withRouter(hoc_withAppContext(PageTitle_PageTitle))));
// CONCATENATED MODULE: ./src/js/data/sections.js
/*
...
function getSectionName(key) {
  switch (key) {
    ...
    default:
      throw new Error(`no such section for key: ${key}`);
  }
}
...
// CONCATENATED MODULE: ./src/js/data/settings.js
...
function createSettingsData({
  ...
  const data = [{
    ...
    tooltip: t('BlockThirdpartycookies', {
      browser
    })
  }, {
  ...
  return data.map(setting => {
    ...
    const value = available && controllable ? settings.getItem(setting.settingID) : !!setting.disabledValue;
...
function getEnabledCount(sectionKey, settingsData) {
  return getSectionSettings(sectionKey, settingsData).map(setting => {
...
// CONCATENATED MODULE: ./src/jsx/component/SettingItem.jsx
...
class SettingItem_SettingItem extends react["Component"] {
  constructor(props) {
    super(props); // properties
  ...
  async toggle() {
    ...
    try {
      ...
      const newValue = await this.settings.toggle(settingID); // call parent function to update parent's state
      ...
      if (changeTheme && settingID === 'darkTheme') {
        changeTheme();
      }
    } catch (err) {
      debug(err);
  ...
  buildLabel() {
    ...
    return react_default.a.createElement("div", {
      ...
      className: `popover arrow-top ${theme} left-align`
    }, tooltip))), react_default.a.createElement(WarningSpan, null), controllable && react_default.a.createElement("div", {
      className: `learnmore-container ${settingID}`
    }, react_default.a.createElement("a", {
  ...
  render() {
    ...
    return available ? react_default.a.createElement("div", {
      className: `setting-item ${theme} noselect`
    }, react_default.a.createElement("div", {
      className: "setting-item-label"
    }, this.buildLabel()), react_default.a.createElement(component_checkbox, {
      id: settingID,
      theme: theme,
      checked: checked,
...
SettingItem_SettingItem.propTypes = {
  settingID: prop_types_default.a.string.isRequired,
  label: prop_types_default.a.string.isRequired,
  tooltip: prop_types_default.a.string,
  onSettingChange: prop_types_default.a.func.isRequired,
  learnMoreHref: prop_types_default.a.string,
  learnMore: prop_types_default.a.string,
  controllable: prop_types_default.a.bool,
  warning: prop_types_default.a.string,
  online: prop_types_default.a.bool.isRequired,
  changeTheme: prop_types_default.a.func.isRequired,
  checked: prop_types_default.a.bool.isRequired,
  available: prop_types_default.a.bool.isRequired,
  context: prop_types_default.a.object.isRequired
};
SettingItem_SettingItem.defaultProps = {
  controllable: true,
  tooltip: '',
  learnMoreHref: '#',
  learnMore: '',
...
/* harmony default export */ var component_SettingItem = (hoc_listenOnline(hoc_withAppContext(SettingItem_SettingItem)));
// CONCATENATED MODULE: ./src/jsx/component/SettingSection.jsx




class SettingSection_SettingsSection extends react["Component"] {
  constructor(props) {
    super(props); // properties
  ...
  render() {
    ...
    return react_default.a.createElement("div", {
      className: `section-wrapper ${name} ${theme} ${open ? 'open' : ''}`
    }, react_default.a.createElement("div", {
      role: "button",
      tabIndex: "-1",
      ...
      className: "counts"
    }, enabledCount, "/", totalCount, "\xA0", t('enabled')), react_default.a.createElement("span", {
...
SettingSection_SettingsSection.propTypes = {
  enabledCount: prop_types_default.a.number.isRequired,
  totalCount: prop_types_default.a.number.isRequired,
  name: prop_types_default.a.string.isRequired,
  label: prop_types_default.a.string.isRequired,
  context: prop_types_default.a.object.isRequired,
  children: prop_types_default.a.oneOfType([prop_types_default.a.object, prop_types_default.a.array]).isRequired
};
/* harmony default export */ var SettingSection = (hoc_withAppContext(SettingSection_SettingsSection));
// CONCATENATED MODULE: ./src/jsx/component/DebugSettingItem.jsx



const DebugSettingItem = ({
  onClick,
  theme
}) => {
  return react_default.a.createElement("div", {
...
/* harmony default export */ var component_DebugSettingItem = (DebugSettingItem);
// CONCATENATED MODULE: ./src/jsx/component/LanguageDropdown.jsx




class LanguageDropdown_LanguageDropdown extends react["Component"] {
  constructor(props) {
    super(props); // properties

    this.app = props.context.app;
    this.i18n = this.app.util.i18n;
    this.storage = this.app.util.storage; // bindings
  ...
  changeLanguage(event) {
    ...
    this.i18n.changeLocale(targetLocale).then(locale => {
      const {
        updateLanguage
      } = this.props;
  ...
  languages() {
    ...
    Array.from(languageMap.entries()).forEach(([locale, string]) => {
      languages.push(react_default.a.createElement("option", {
        key: locale,
        value: locale,
  ...
  render() {
    ...
    return react_default.a.createElement("div", {
      className: `languages-container ${theme} dropdown`
...
LanguageDropdown_LanguageDropdown.propTypes = {
  context: prop_types_default.a.object.isRequired,
  updateLanguage: prop_types_default.a.func.isRequired
};
/* harmony default export */ var component_LanguageDropdown = (hoc_withAppContext(LanguageDropdown_LanguageDropdown));
// CONCATENATED MODULE: ./src/jsx/component/SettingSections.jsx
...
class SettingSections_SettingSections extends react["Component"] {
  constructor(props) {
    super(props); // properties

    this.app = props.context.app;
    this.languageDropdown = component_LanguageDropdown;
    const {
      settings,
      user
    } = this.app.util;
  ...
  getSectionProps(sectionKey) {
    ...
    const {
      name,
      label
    } = getSection(sectionKey, sectionsData);
  ...
  languageDropdownBuilder() {
    ...
    }, t('UILanguage'), react_default.a.createElement("div", {
      className: `popover arrow-bottom ${theme} left-align`
    }, t('UILanguageTooltip')))), react_default.a.createElement("div", {
      className: "checkbox-container"
    }, react_default.a.createElement(LanguageDropDown, {
  ...
  render() {
    ...
    return react_default.a.createElement(react["Fragment"], null, react_default.a.createElement(SettingSection, this.getSectionProps('security'), react_default.a.createElement(component_SettingItem, this.getSettingProps('blockadobeflash')), react_default.a.createElement(component_SettingItem, this.getSettingProps('preventwebrtcleak')), react_default.a.createElement(component_SettingItem, this.getSettingProps('httpsUpgrade'))), react_default.a.createElement(SettingSection, this.getSectionProps('privacy'), react_default.a.createElement(component_SettingItem, this.getSettingProps('blockcamera')), react_default.a.createElement(component_SettingItem, this.getSettingProps('blockmicrophone')), react_default.a.createElement(component_SettingItem, this.getSettingProps('blocklocation')), react_default.a.createElement(component_SettingItem, this.getSettingProps('blocknetworkprediction')), react_default.a.createElement(component_SettingItem, this.getSettingProps('blocksafebrowsing')), react_default.a.createElement(component_SettingItem, this.getSettingProps('blockautofillcreditcard')), react_default.a.createElement(component_SettingItem, this.getSettingProps('blockautofilladdress')), react_default.a.createElement(component_SettingItem, this.getSettingProps('blockautofill'))), react_default.a.createElement(SettingSection, this.getSectionProps('tracking'), react_default.a.createElement(component_SettingItem, this.getSettingProps('blockthirdpartycookies')), react_default.a.createElement(component_SettingItem, this.getSettingProps('blockreferer')), react_default.a.createElement(component_SettingItem, this.getSettingProps('blockhyperlinkaudit')), react_default.a.createElement(component_SettingItem, this.getSettingProps('blockutm')), react_default.a.createElement(component_SettingItem, this.getSettingProps('blockfbclid')), react_default.a.createElement(component_SettingItem, this.getSettingProps('maceprotection'))), react_default.a.createElement(SettingSection, this.getSectionProps('extension'), react_default.a.createElement(component_SettingItem, this.getSettingProps('allowExtensionNotifications')), react_default.a.createElement(component_SettingItem, this.getSettingProps('darkTheme')), react_default.a.createElement(component_SettingItem, this.getSettingProps('debugmode')), getSetting('debugmode', settingsData).value && react_default.a.createElement(component_DebugSettingItem, {
...
SettingSections_SettingSections.propTypes = {
  context: prop_types_default.a.object.isRequired,
  changeTheme: prop_types_default.a.func.isRequired,
  onDebugClick: prop_types_default.a.func.isRequired
};
/* harmony default export */ var component_SettingSections = (hoc_withAppContext(SettingSections_SettingSections));
// CONCATENATED MODULE: ./src/jsx/component/bypasslist/BypassSettingSection.jsx





class BypassSettingSection_BypassSettingSection extends react["Component"] {
  constructor(props) {
    super(props); // properties

    this.app = props.context.app;
    this.history = props.history;
    this.bypasslist = this.app.util.bypasslist; // bindings
  ...
  render() {
    ...
    if (count === 0) {
      listDetails = t('NoRulesAdded');
    } else if (count === 1) {
      listDetails = t('OneRuleAdded');
    } else {
      listDetails = t('MultipleRulesAdded', {
        count
      });
    }

    return react_default.a.createElement("div", {
      className: `section-wrapper bypass ${theme}`
    }, react_default.a.createElement("div", {
      role: "button",
      tabIndex: "-1",
      className: "section-header noselect",
      ...
      className: "section-label"
    }, t('ProxyBypassList')), react_default.a.createElement("div", {
      className: "rightalign"
    }, react_default.a.createElement("span", {
      className: "counts"
    }, listDetails), react_default.a.createElement("span", {
      className: "expandicon lefticon"
    }))));
  }

}

BypassSettingSection_BypassSettingSection.propTypes = {
  context: prop_types_default.a.object.isRequired,
  history: prop_types_default.a.object.isRequired
};
/* harmony default export */ var bypasslist_BypassSettingSection = (react_router_dom_es_withRouter(hoc_withAppContext(BypassSettingSection_BypassSettingSection)));
// CONCATENATED MODULE: ./src/jsx/pages/SettingsPage.jsx
...
class SettingsPage_SettingsPage extends react["Component"] {
  constructor(props) {
    super(props); // properties
    ...
    this.buildinfo = this.app.buildinfo;
    this.settings = this.app.util.settings;
    this.updateTheme = props.context.updateTheme; // bindings
  ...
  buildInfo() {
    ...
    const numValidHashes = [gitcommit, gitbranch].filter(e => {
    ...
    return react_default.a.createElement("div", {
      ...
      return react_default.a.createElement("div", {
        ...
        className: "title"
      }, title), react_default.a.createElement("span", null, value));
    }));
  }
  ...
  render() {
    ...
    return react_default.a.createElement("div", {
      ...
      className: `top-border ${theme}`,
      id: "settings"
    }, react_default.a.createElement(component_PageTitle, {
      text: t('ChangeExtensionSettings')
    }), react_default.a.createElement(component_SettingSections, {
      changeTheme: this.changeTheme,
      onDebugClick: this.onDebugClick
    }), react_default.a.createElement(bypasslist_BypassSettingSection, null), react_default.a.createElement("div", {
      className: `panelfooter ${theme}`
    }, react_default.a.createElement("div", null, "v", this.buildinfo.version, "\xA0 (", react_default.a.createElement("a", {
      href: "#changelog",
      onClick: this.viewChangeLog
    }, t('ViewChangelog')), ")", react_default.a.createElement(BuildInfo, null)))));
  }

}

SettingsPage_SettingsPage.propTypes = {
  context: prop_types_default.a.object.isRequired,
  history: prop_types_default.a.object.isRequired
};
/* harmony default export */ var pages_SettingsPage = (react_router_dom_es_withRouter(hoc_withAppContext(SettingsPage_SettingsPage)));
// EXTERNAL MODULE: ./node_modules/react-timeago/lib/index.js
var lib = __webpack_require__(102);
var lib_default = /*#__PURE__*/__webpack_require__.n(lib);

// CONCATENATED MODULE: ./src/jsx/component/ClipboardButton.jsx




class ClipboardButton_ClipboardButton extends react["Component"] {
  constructor(props) {
    super(props); // properties

    this.app = props.context.app;
    this.logger = this.app.logger;
    this.platforminfo = this.app.util.platforminfo; // bindings
  ...
  copyToClipboard(event) {
    event.preventDefault(); // grab message from debug log

    const messages = this.logger.getEntries().map(entry => {
      // entry[0] timestamp
      // entry[1] message
      return entry[1];
    }).join(this.platforminfo.lineEnding());
    event.clipboardData.setData('Text', messages); // update copy button text
...
ClipboardButton_ClipboardButton.propTypes = {
  context: prop_types_default.a.object.isRequired
};
/* harmony default export */ var component_ClipboardButton = (hoc_withAppContext(ClipboardButton_ClipboardButton));
// CONCATENATED MODULE: ./src/jsx/component/DeleteLogButton.jsx




class DeleteLogButton_DeleteLogButton extends react["Component"] {
  constructor(props) {
    super(props); // properties

    this.app = props.context.app;
    this.logger = this.app.logger; // bindings
...
DeleteLogButton_DeleteLogButton.propTypes = {
  context: prop_types_default.a.object.isRequired,
  parentComponent: prop_types_default.a.object.isRequired
};
/* harmony default export */ var component_DeleteLogButton = (hoc_withAppContext(DeleteLogButton_DeleteLogButton));
// CONCATENATED MODULE: ./src/jsx/pages/DebugLogPage.jsx
...
class DebugLogPage_DebuglogPage extends react["Component"] {
  constructor(props) {
    super(props); // properties
  ...
  renderEntries() {
    ...
    return entries.map(([timestamp, message]) => {
      ...
      return react_default.a.createElement("li", {
        ...
        className: "bold"
      }, message), react_default.a.createElement(lib_default.a, {
        live: false,
        date: timestamp
      }));
    });
  ...
  render() {
    ...
    if (platforminfo.ready === false) {
      return react_default.a.createElement("div", {
        ...
        className: "still-loading"
      }, t('TheExtensionIsStillLoading')), react_default.a.createElement("div", {
    ...
    }, react_default.a.createElement(component_ClipboardButton, null), react_default.a.createElement(component_DeleteLogButton, {
      parentComponent: this
    })), react_default.a.createElement("ul", null, this.renderEntries()));
  }

}

DebugLogPage_DebuglogPage.propTypes = {
  context: prop_types_default.a.object.isRequired
};
/* harmony default export */ var DebugLogPage = (hoc_withAppContext(DebugLogPage_DebuglogPage));
// EXTERNAL MODULE: ./src/js/helpers/http.js
var http = __webpack_require__(33);

// CONCATENATED MODULE: ./src/jsx/pages/ChangeLogPage.jsx
...
class ChangeLogPage_ChangelogPage extends react["Component"] {
  constructor(props) {
    super(props); // properties
  ...
  componentDidMount() {
    ...
    http["a" /* default */].get(url).then(success).catch(error);
  }
...
ChangeLogPage_ChangelogPage.propTypes = {
  context: prop_types_default.a.object.isRequired
};
/* harmony default export */ var ChangeLogPage = (hoc_withAppContext(ChangeLogPage_ChangelogPage));
// CONCATENATED MODULE: ./src/jsx/component/bypasslist/BypassItem.jsx
...
const BypassItem = ({
  ...
  return react_default.a.createElement("div", {
    className: `bypass-rule ${theme}`
  }, react_default.a.createElement("span", {
    className: "name"
  }, rule), react_default.a.createElement("span", {
    role: "button",
    tabIndex: "-1",
    className: "rem",
...
BypassItem.propTypes = {
  rule: prop_types_default.a.string.isRequired,
  theme: prop_types_default.a.string.isRequired,
  onRemoveItem: prop_types_default.a.func.isRequired
};
/* harmony default export */ var bypasslist_BypassItem = (BypassItem);
// CONCATENATED MODULE: ./src/jsx/component/bypasslist/UserRules.jsx





class UserRules_UserRules extends react["Component"] {
  constructor(props) {
    super(props); // properties
  ...
  createBypassItem(rule) {
    ...
    return react_default.a.createElement(bypasslist_BypassItem, {
      key: rule,
      theme: theme,
      rule: rule,
  ...
  render() {
    ...
    return react_default.a.createElement("div", {
      className: "user-rules"
    }, react_default.a.createElement("h3", {
      className: "bl_sectionheader instructions"
    }, t('OtherWebsites')), react_default.a.createElement("div", {
      className: "introtext"
    }, react_default.a.createElement("span", {
      className: "bold"
    }, t('BypassInstructionsBold')), "\xA0", t('BypassInstructions')), react_default.a.createElement("div", {
      className: `add-container ${theme}`
    }, react_default.a.createElement("input", {
      type: "text",
      name: "rule",
      maxLength: "32779",
      ...
      disabled: !this.region,
      onClick: this.save
    }, react_default.a.createElement("p", null, "+"))), react_default.a.createElement("div", {
      className: `rule-list ${!this.region ? 'disabled' : ''} ${theme}`
    }, userRules.map(this.createBypassItem)));
  }

}

UserRules_UserRules.propTypes = {
  context: prop_types_default.a.object.isRequired
};
/* harmony default export */ var bypasslist_UserRules = (hoc_withAppContext(UserRules_UserRules));
// CONCATENATED MODULE: ./src/jsx/component/bypasslist/PopularRule.jsx
...
class PopularRule_PopularRule extends react["Component"] {
  constructor(props) {
    super(props); // properties
    ...
    this.region = this.app.util.regionlist.getSelectedRegion();
    this.state = {
      checked: this.bypasslist.isRuleEnabled(this.defaultName)
    }; // Bindings
  ...
  onChange({
    ...
    if (checked) {
      this.bypasslist.enablePopularRule(this.defaultName);
    } else {
      this.bypasslist.disablePopularRule(this.defaultName);
    }
  ...
  render() {
    ...
    return react_default.a.createElement("li", {
      className: `popular-rule ${theme}`
    }, react_default.a.createElement("label", {
      htmlFor: this.defaultName,
      className: "noselect popular-rule-name"
    }, this.defaultName), react_default.a.createElement(component_checkbox, {
      id: this.defaultName,
      theme: theme,
      checked: checked,
      disabled: !this.region,
...
PopularRule_PopularRule.propTypes = {
  context: prop_types_default.a.object.isRequired,
  defaultName: prop_types_default.a.string.isRequired
};
/* harmony default export */ var bypasslist_PopularRule = (errorboundary(hoc_withAppContext(PopularRule_PopularRule)));
// CONCATENATED MODULE: ./src/jsx/component/bypasslist/PopularRules.jsx
...
const PopularRules = ({
  ...
  return react_default.a.createElement("div", null, react_default.a.createElement("h3", {
    className: "bl_sectionheader"
  }, t('PopularWebsites')), react_default.a.createElement("div", {
    className: "popular"
  }, popularRules.map(name => {
    return react_default.a.createElement(bypasslist_PopularRule, {
      defaultName: name,
      key: name
    });
  })));
...
PopularRules.propTypes = {
  popularRules: prop_types_default.a.array.isRequired
};
/* harmony default export */ var bypasslist_PopularRules = (PopularRules);
// CONCATENATED MODULE: ./src/js/helpers/file.js
/**
...
class File {
  ...
  constructor(fileType, fileParts) {
    ...
    this.onChangedListener = this.onChangedListener.bind(this); // Init
  ...
  downloadViaApi(url, filename) {
    ...
    const {
      download
    } = downloads; // handle revoking object url here
...
/* harmony default export */ var helpers_file = (File);
// CONCATENATED MODULE: ./src/jsx/component/bypasslist/ImportExportRules.jsx





class ImportExportRules_ImportExportRules extends react["Component"] {
  constructor(props) {
    super(props); // properties
    ...
    this.bypasslist = this.app.util.bypasslist;
    this.region = this.app.util.regionlist.getSelectedRegion(); // bindings
  ...
  onExportClick() {
    ...
    const file = new helpers_file('application/json', [payload]);
  ...
  render() {
    ...
    return react_default.a.createElement("div", {
      ...
      className: "bl_sectionheader"
    }, t('ImportExportHeader')), react_default.a.createElement("div", {
    ...
    }, t('ImportLabel')), react_default.a.createElement("button", {
      type: "button",
      className: "btn btn-success",
      onClick: this.onExportClick
    }, t('ExportLabel'), react_default.a.createElement("img", {
      className: `${showClass}`,
      alt: "Exported",
...
ImportExportRules_ImportExportRules.propTypes = {
  context: prop_types_default.a.object.isRequired
};
/* harmony default export */ var bypasslist_ImportExportRules = (hoc_withAppContext(ImportExportRules_ImportExportRules));
// CONCATENATED MODULE: ./src/jsx/pages/BypassListPage.jsx
...
class BypassListPage_BypassListPage extends react["Component"] {
  constructor(props) {
    super(props); // properties
  ...
  render() {
    ...
    return react_default.a.createElement("div", {
      ...
      text: t('ProxyBypassList')
    }), react_default.a.createElement("div", {
      className: "bypass-wrap"
    }, react_default.a.createElement("p", {
      className: "introtext",
      dangerouslySetInnerHTML: {
        __html: t('BypassWarning')
      }
    }), react_default.a.createElement(bypasslist_ImportExportRules, null), react_default.a.createElement(bypasslist_PopularRules, {
      popularRules: this.popularRules
    }), react_default.a.createElement(bypasslist_UserRules, null)));
  }

}

BypassListPage_BypassListPage.propTypes = {
  context: prop_types_default.a.object.isRequired
};
/* harmony default export */ var pages_BypassListPage = (hoc_withAppContext(BypassListPage_BypassListPage));
// CONCATENATED MODULE: ./src/js/eventhandler/pages/changeregion/onFlagError.js
function OnFlagError(event, region) {
  const {
    target
  } = event;
...
// CONCATENATED MODULE: ./src/jsx/component/RegionListItem.jsx
...
class RegionListItem_RegionListItem extends react["Component"] {
  constructor(props) {
    super(props); // properties
  ...
  renderFlag() {
    if (this.region.override) {
      return react_default.a.createElement("div", {
        className: "empty-flag"
      });
    }
  ...
  renderLatency() {
    if (this.region.offline) {
      return react_default.a.createElement("div", {
        className: "list-item-latency server-offline-text"
      }, t('OfflineText'));
    }
    ...
    const latencyClass = (() => {
      if (latency === 'ERROR' || latency > 500 || latency === 'PENDING') {
        return 'latency-red';
      }

      if (latency <= 150 && latency > 0) {
        return 'latency-green';
      }

      if (latency <= 500 && latency > 150) {
    ...
    return react_default.a.createElement("div", {
      className: `list-item-latency ${latencyClass}`
    }, latencyValue);
  }
  ...
  render() {
    ...
    }, flag), react_default.a.createElement("span", {
      className: "regionnamelist"
    }, this.region.localizedName()), latencyDiv, favorite);
  }

}

RegionListItem_RegionListItem.propTypes = {
  nested: prop_types_default.a.bool,
  region: prop_types_default.a.object.isRequired,
  context: prop_types_default.a.object.isRequired,
  history: prop_types_default.a.object.isRequired,
  onRegionUpdated: prop_types_default.a.func.isRequired
};
RegionListItem_RegionListItem.defaultProps = {
  nested: false
};
/* harmony default export */ var component_RegionListItem = (react_router_dom_es_withRouter(hoc_withAppContext(RegionListItem_RegionListItem)));
// CONCATENATED MODULE: ./src/jsx/component/RegionIso.jsx
...
class RegionIso_RegionIso extends react["Component"] {
  constructor(props) {
    super(props); // bindings
    ...
    this.toggleRegionVisibility = this.toggleRegionVisibility.bind(this); // properties

    this.iso = props.iso;
    this.app = props.context.app;
    this.storage = this.app.util.storage; // check storage to see if the regions should be visible

    let show = true;
    const visibleISOs = this.getRegionVisibility();

    if (Object.keys(visibleISOs).includes(this.iso)) {
      show = visibleISOs[this.iso];
    }
  ...
  getRegionVisibility() {
    ...
    try {
      visibleISOs = JSON.parse(visibleISOs);
    } catch (err) {
      visibleISOs = {};
    }
  ...
  toggleRegionVisibility() {
    ...
    const visibleISOs = this.getRegionVisibility(); // update storage

    visibleISOs[this.iso] = !showRegions;
    this.storage.setItem('visibleISOs', JSON.stringify(visibleISOs)); // update state
  ...
  localizeIsoName() {
    ...
    const isos = ['de', 'ca', 'us', 'au', 'gb']; // check if this.iso is within the set of grouped isos
    // Fall back to displaying the capitalized country code if no country name is known

    if (!isos.includes(currentIso)) {
      return currentIso.toUpperCase();
  ...
  calculateRegionHeight() {
    ...
    const {
      showRegions
    } = this.state; // calculate height based on number of regions nested

    if (showRegions) {
      return 35 * regions.length;
    }
  ...
  render() {
    ...
    const componentRegions = regions.map(region => {
      return react_default.a.createElement(component_RegionListItem, {
        key: region.id,
        nested: true,
        region: region,
        onRegionUpdated: updateRegionsLocally
      });
    });
    return react_default.a.createElement("div", {
      role: "button",
      ...
      className: "iso-display noselect"
    }, react_default.a.createElement("div", {
      className: "arrow-container"
    }, react_default.a.createElement("div", {
      className: `iso-arrow ${showRegions ? 'open' : ''}`
    })), react_default.a.createElement("div", {
      className: "flag-container"
    }, react_default.a.createElement("img", {
      className: "flag",
      ...
      className: "regionnamelist"
    }, this.localizeIsoName())), react_default.a.createElement("div", {
      className: "iso-regions",
      style: {
...
RegionIso_RegionIso.propTypes = {
  iso: prop_types_default.a.string.isRequired,
  regions: prop_types_default.a.array.isRequired,
  context: prop_types_default.a.object.isRequired,
  updateRegionsLocally: prop_types_default.a.func.isRequired
};
/* harmony default export */ var component_RegionIso = (hoc_withAppContext(RegionIso_RegionIso));
// CONCATENATED MODULE: ./src/jsx/component/LoadingEllipsis.jsx
...
const LoadingEllipsis = ({
  ...
  return react_default.a.createElement("div", {
    className: `loading-auto ${theme}`
  }, react_default.a.createElement("span", {
    className: "loading-auto-text"
  }, t('CalculatingLatency')), react_default.a.createElement("div", {
    className: "loading-auto-animation"
  }, react_default.a.createElement("div", {
    className: "loading"
  }, react_default.a.createElement("span", {
    className: "one"
...
/* harmony default export */ var component_LoadingEllipsis = (LoadingEllipsis);
// CONCATENATED MODULE: ./src/jsx/component/RegionAuto.jsx
...
class RegionAuto_RegionAuto extends react["Component"] {
  constructor(props) {
    super(props); // properties
  ...
  render() {
    ...
    if (autoLoading) {
      return react_default.a.createElement(component_LoadingEllipsis, {
        theme: theme
      });
    }
    ...
    return react_default.a.createElement("div", {
      ...
      className: "flag-container"
    }, region.override ? react_default.a.createElement("div", {
      className: "empty-flag"
    }) : react_default.a.createElement("img", {
      className: "flag",
      alt: region.iso,
      ...
      className: `region-name-title ${isAuto ? 'active' : ''}`
    }, t('ChooseAutomatically')), react_default.a.createElement("div", {
      className: "region-name-label"
    }, region.localizedName())), react_default.a.createElement("div", {
      className: "list-item-latency"
    }), react_default.a.createElement("div", {
...
RegionAuto_RegionAuto.propTypes = {
  region: prop_types_default.a.object.isRequired,
  context: prop_types_default.a.object.isRequired,
  history: prop_types_default.a.object.isRequired,
  autoLoading: prop_types_default.a.bool.isRequired
};
/* harmony default export */ var component_RegionAuto = (react_router_dom_es_withRouter(hoc_withAppContext(RegionAuto_RegionAuto)));
// CONCATENATED MODULE: ./src/jsx/component/RegionList.jsx
...
class RegionList_RegionList extends react["Component"] {
  constructor(props) {
    super(props); // properties
    ...
    this.storage = this.app.util.storage;
    this.regionlist = this.app.util.regionlist;
    this.regionsorter = this.app.util.regionsorter; // bindings
  ...
  filterRegions(regions) {
    const {
      ...
      search,
      showFavorites
    } = this.props; // determine sort order

    let sort = this.regionsorter.nameSort;

    if (sortBy === 'latency') {
      sort = this.regionsorter.latencySort;
    } // sort by name or latency


    return sort(regions) // filter by search input
    .filter(region => {
      return region.localizedName().toLowerCase().includes(search.toLowerCase());
    }) // filter favorites
    .filter(region => {
      if (showFavorites) {
        return region.isFavorite;
      }
  ...
  componentizeRegions() {
    ...
    Object.values(filteredRegions).forEach(isoRegions => {
      const region = isoRegions[0];

      if (isoRegions.length === 1) {
        componentRegions.push(react_default.a.createElement(component_RegionListItem, {
          key: region.id,
          region: region,
          onRegionUpdated: updateRegionsLocally
        }));
        ...
        componentRegions.push(react_default.a.createElement(component_RegionIso, {
          key: iso,
          iso: iso,
          regions: isoRegions,
  ...
  renderAutoRegion() {
    ...
    return react_default.a.createElement(component_RegionAuto, {
      region: region,
  ...
  render() {
    ...
    } = this.props; // Loading screen when between actions

    if (mode === 'loading') {
      return react_default.a.createElement("div", {
        className: "regions centered"
      }, react_default.a.createElement(component_Switch, {
        theme: theme,
        mode: "connecting",
    ...
    if (regions.length === 0) {
      return react_default.a.createElement("div", {
        className: "no-regions"
      }, react_default.a.createElement("div", {
        className: `no-regions-title ${theme}`
      }, t('NoRegionsFound')), react_default.a.createElement("button", {
        type: "button",
        className: "btn btn-success",
    ...
    return react_default.a.createElement("div", {
      ...
      className: "auto-region"
    }, this.renderAutoRegion()), react_default.a.createElement("ul", {
...
RegionList_RegionList.propTypes = {
  mode: prop_types_default.a.string.isRequired,
  search: prop_types_default.a.string.isRequired,
  regions: prop_types_default.a.array.isRequired,
  sortBy: prop_types_default.a.string.isRequired,
  context: prop_types_default.a.object.isRequired,
  autoLoading: prop_types_default.a.bool.isRequired,
  showFavorites: prop_types_default.a.bool.isRequired,
  updateRegionsLocally: prop_types_default.a.func.isRequired,
  updateRegionsRemotely: prop_types_default.a.func.isRequired
};
/* harmony default export */ var component_RegionList = (hoc_withAppContext(RegionList_RegionList));
// CONCATENATED MODULE: ./src/jsx/component/RegionSearch.jsx
...
RegionSearch.propTypes = {
  theme: prop_types_default.a.string.isRequired,
  search: prop_types_default.a.string.isRequired,
  onSearchUpdate: prop_types_default.a.func.isRequired
};
/* harmony default export */ var component_RegionSearch = (RegionSearch);
// CONCATENATED MODULE: ./src/jsx/pages/ChangeRegionPage.jsx
...
class ChangeRegionPage_ChangeRegionPage extends react["Component"] {
  constructor(props) {
    super(props); // properties
  ...
  changeSortBy(event) {
    ...
    if (value === 'latency') {
      this.storage.setItem('sortby', 'latency');
    } else {
      this.storage.setItem('sortby', 'name');
    }
  ...
  render() {
    ...
    return react_default.a.createElement("div", {
      id: "change-region-page",
      className: `row ${theme}`
    }, react_default.a.createElement(component_PageTitle, {
      text: t('SelectRegionText')
    }), react_default.a.createElement(component_RegionSearch, {
      theme: theme,
      search: search,
      onSearchUpdate: this.onSearchUpdate
    }), react_default.a.createElement("div", {
      className: `region-sort-selection ${theme}`
    }, react_default.a.createElement("button", {
      type: "button",
      "data-value": "name",
      onClick: this.changeSortBy,
      className: `name ${sortBy === 'name' ? 'active' : ''}`
    }, t('RegionName')), react_default.a.createElement("button", {
      type: "button",
      "data-value": "latency",
      onClick: this.changeSortBy,
      className: `latency ${sortBy === 'latency' ? 'active' : ''}`
    }, t('RegionLatency')), this.renderFavorite()), react_default.a.createElement(component_RegionList, {
      mode: mode,
      search: search,
      sortBy: sortBy,
      regions: regions,
...
ChangeRegionPage_ChangeRegionPage.propTypes = {
  context: prop_types_default.a.object.isRequired
};
/* harmony default export */ var pages_ChangeRegionPage = (hoc_withAppContext(ChangeRegionPage_ChangeRegionPage));
// CONCATENATED MODULE: ./src/jsx/component/tiles/Tile.jsx




class Tile_Tile extends react["Component"] {
  constructor(props) {
    super(props); // properties
  ...
  buildFlag() {
    ...
    if (saved) {
      flagUrl = '/images/tiles/bookmark/bookmark-green.svg';
    } else if (theme === 'dark') {
      flagUrl = '/images/tiles/bookmark/bookmark-dark.svg';
    } else {
      flagUrl = '/images/tiles/bookmark/bookmark-light.svg';
    }
  ...
  buildClassName() {
    ...
    if (saved) {
      classList.push('saved', 'drawer-tile');
    }

    if (close) {
      classList.push('close');
    }
  ...
  render() {
    ...
    return react_default.a.createElement("div", {
      ...
      className: `${name.toLowerCase()} child noselect`
    }, this.buildFlag(), children));
  }

}

Tile_Tile.propTypes = {
  saved: prop_types_default.a.bool.isRequired,
  name: prop_types_default.a.string.isRequired,
  hideFlag: prop_types_default.a.bool.isRequired,
  context: prop_types_default.a.object.isRequired,
  children: prop_types_default.a.object.isRequired,
  toggleTileSaved: prop_types_default.a.func.isRequired
};
/* harmony default export */ var tiles_Tile = (hoc_withAppContext(Tile_Tile));
// CONCATENATED MODULE: ./src/jsx/component/CurrentRegion.jsx
...
class CurrentRegion_CurrentRegion extends react["Component"] {
  constructor(props) {
    super(props); // properties

    this.app = props.context.app;
    this.history = props.history;
    this.isAuto = this.app.util.regionlist.getIsAuto(); // bindings
  ...
  getRegionName() {
    ...
    if (isAuto && region) {
      regionName = `${t('Auto')} (${region.localizedName()})`;
    } else if (region) {
      regionName = region.localizedName();
    } else {
      regionName = t('NoRegionSelected');
    }
  ...
  render() {
    ...
    return react_default.a.createElement("div", {
      ...
      className: "flag"
    }, region && !region.override ? react_default.a.createElement("img", {
      alt: region.iso,
      onError: this.onFlagLoadError,
      src: region.flag
    }) : react_default.a.createElement("div", {
      ...
      className: "title"
    }, t('CurrentRegionText')), react_default.a.createElement("div", {
      className: "name"
    }, this.getRegionName()))), react_default.a.createElement("div", {
      className: "go-forward-image"
    }));
  }

}

CurrentRegion_CurrentRegion.propTypes = {
  region: prop_types_default.a.object,
  context: prop_types_default.a.object.isRequired,
  history: prop_types_default.a.object.isRequired,
  autoLoading: prop_types_default.a.bool.isRequired
};
CurrentRegion_CurrentRegion.defaultProps = {
  region: undefined
};
/* harmony default export */ var component_CurrentRegion = (react_router_dom_es_withRouter(hoc_withAppContext(CurrentRegion_CurrentRegion)));
// CONCATENATED MODULE: ./src/jsx/component/tiles/RegionTile.jsx
...
const RegionTile = props => {
  ...
  return react_default.a.createElement(tiles_Tile, {
    name: "RegionTile",
    saved: saved,
    hideFlag: hideFlag,
    toggleTileSaved: toggleTileSaved
  }, react_default.a.createElement(component_CurrentRegion, {
    id: "region",
    region: region,
    autoLoading: autoLoading
  }));
...
/* harmony default export */ var tiles_RegionTile = (RegionTile);
// CONCATENATED MODULE: ./src/jsx/component/tiles/BypassRules.jsx





class BypassRules_BypassRules extends react["Component"] {
  constructor(props) {
    super(props); // properties
  ...
  render() {
    ...
    return react_default.a.createElement(tiles_Tile, {
      ...
      className: `bypass-rules ${theme}`
    }, react_default.a.createElement("div", {
      className: "bypass-rules-header"
    }, react_default.a.createElement("div", null, t('AddToBypassRules')), react_default.a.createElement("div", {
      className: `bypass-rule-included image ${this.ruleIncluded() ? 'active' : ''}`
    }, react_default.a.createElement("img", {
      alt: t('RuleAlreadyIncluded'),
      title: t('RuleAlreadyIncluded'),
      src: "/images/selected_2x.png"
    })), react_default.a.createElement("div", {
      className: `bypass-rule-included remove ${this.ruleIncluded() ? 'active' : ''}`
    }, react_default.a.createElement("button", {
      type: "button",
      className: "remove-rule",
      onClick: this.removeRule
    }, `- ${t('RemoveRule')}`))), react_default.a.createElement("div", {
      className: "bypass-rules-content"
    }, react_default.a.createElement("div", {
      className: "bypass-rules-add-container"
    }, react_default.a.createElement("input", {
      className: "add-rule-input",
      value: origin,
...
BypassRules_BypassRules.propTypes = {
  saved: prop_types_default.a.bool.isRequired,
  hideFlag: prop_types_default.a.bool.isRequired,
  context: prop_types_default.a.object.isRequired,
  toggleTileSaved: prop_types_default.a.func.isRequired
};
/* harmony default export */ var tiles_BypassRules = (hoc_withAppContext(BypassRules_BypassRules));
// CONCATENATED MODULE: ./src/jsx/component/tiles/QuickConnect.jsx
...
class QuickConnect_QuickConnect extends react["Component"] {
  constructor(props) {
    super(props); // properties
  ...
  onClick(e) {
    ...
    if (region.id === regionId && this.proxy.enabled()) {
      return;
    }
  ...
  filterFavRegions(regions) {
    return this.regionsorter.latencySort(regions).filter(region => {
      return region.isFavorite;
    });
  }
  ...
  filterRegions(regions) {
    // group regions by ISO
    return this.regionsorter.latencySort(regions).reduce((prev, curr) => {
      const isoMap = prev;
  ...
  componentizeRegions() {
    ...
    const componentRegions = [];
    Object.values(favoriteRegions).forEach(isoRegions => {
      const region = isoRegions;
      componentRegions.push(this.createComponent(region, true));
    });

    if (componentRegions.length > 6) {
      return componentRegions.slice(0, 6);
    }
    ...
    Object.values(allRegions).forEach(isoRegions => {
      const region = isoRegions;
  ...
  createComponent(newRegion, isFav) {
    ...
    if (region && region.id === newRegion.id) {
      classList.push(mode, connection);
    }
  ...
  renderFlag(region, isFavorite) {
    if (isFavorite) {
      ...
      if (theme === 'dark') {
        heartUrl = '/images/green-heart-outline-dark.svg';
      }

      return react_default.a.createElement("div", {
        className: "fav-region"
      }, react_default.a.createElement("div", {
        role: "button",
        tabIndex: "-1",
  ...
  render() {
    ...
    if (autoLoading) {
      return react_default.a.createElement(tiles_Tile, {
        ...
        className: `quick-connect ${theme}`
      }, react_default.a.createElement("div", {
        className: "quick-connect-header"
      }, t('QuickConnect')), react_default.a.createElement("div", {
        className: "quick-connect-warning"
      }, react_default.a.createElement(component_LoadingEllipsis, {
        theme: theme
      }))));
    }
    ...
    if (!hasRegions) {
      return react_default.a.createElement(tiles_Tile, {
        ...
        className: `quick-connect-warning ${theme}`
      }, t('NoRegionsFound'))));
    }
    ...
    return react_default.a.createElement(tiles_Tile, {
      ...
      className: "quick-connect-header"
    }, `${t('QuickConnect')} ${regionName ? `- ${regionName}` : ''}`), react_default.a.createElement("div", {
      className: "quick-connect-flags"
    }, this.componentizeRegions())));
  }

}

QuickConnect_QuickConnect.propTypes = {
  region: prop_types_default.a.object,
  saved: prop_types_default.a.bool.isRequired,
  mode: prop_types_default.a.string.isRequired,
  hideFlag: prop_types_default.a.bool.isRequired,
  ...
  autoLoading: prop_types_default.a.bool.isRequired,
  connection: prop_types_default.a.string.isRequired,
  onQuickConnect: prop_types_default.a.func.isRequired,
  toggleTileSaved: prop_types_default.a.func.isRequired
};
QuickConnect_QuickConnect.defaultProps = {
  region: undefined
};
/* harmony default export */ var tiles_QuickConnect = (hoc_withAppContext(QuickConnect_QuickConnect));
// CONCATENATED MODULE: ./src/jsx/component/tiles/Subscription.jsx





class Subscription_Subscription extends react["Component"] {
  constructor(props) {
    super(props); // properties
  ...
  generateSubscriptionData() {
    ...
    if (plan && expiration) {
      ...
      this.user.updateAccount().then(account => {
    ...
    if (plan && expirationDays) {
      ...
      }, plan), react_default.a.createElement("span", {
        className: "subscription-expiration"
  ...
  render() {
    ...
    return react_default.a.createElement(tiles_Tile, {
      ...
      className: `subscription ${theme}`
    }, react_default.a.createElement("div", {
      className: "subscription-header"
    }, t('Subscription')), this.generateSubscriptionData()));
  }

}

Subscription_Subscription.propTypes = {
  saved: prop_types_default.a.bool.isRequired,
  hideFlag: prop_types_default.a.bool.isRequired,
  context: prop_types_default.a.object.isRequired,
  toggleTileSaved: prop_types_default.a.func.isRequired
};
/* harmony default export */ var tiles_Subscription = (hoc_withAppContext(Subscription_Subscription));
// CONCATENATED MODULE: ./src/jsx/component/tiles/QuickSettings.jsx
...
class QuickSettings_QuickSettings extends react["Component"] {
  constructor(props) {
    super(props); // properties
    ...
    this.state = {
      ...
      settings: {
        ...
        blockreferer: {
          id: 'blockreferer',
          display: t('HTTPREFERRER'),
          folder: 'referer'
        },
        debugmode: {
          id: 'debugmode',
          display: t('DEBUGLOGGING'),
          folder: 'debug'
        },
        darkTheme: {
          id: 'darkTheme',
          display: t('LIGHTTHEME'),
          folder: 'theme'
        },
        blockcamera: {
          id: 'blockcamera',
          display: t('BLOCKCAMERA'),
          folder: 'camera'
        },
        blockmicrophone: {
          id: 'blockmicrophone',
          display: t('BLOCKMICROPHONE'),
          folder: 'audio'
        },
        viewAll: {
          id: 'viewAll',
  ...
  onClick(e) {
    ...
    this.settings.toggle(optionId).then(newValue => {
      const {
        settings
      } = this.state;
  ...
  generateSetting(setting) {
    ...
    } = this.props; // determine setting state

    let active = false;

    if (setting.id !== 'viewAll') {
      active = this.settings.getItem(setting.id);
    }
    ...
    if (active && hover) {
      imgUrl = `${baseUrl}/green.png`;
    } else if (active) {
      imgUrl = `${baseUrl}/greenDark20.png`;
    } else if (theme === 'dark' && hover) {
      imgUrl = `${baseUrl}/grey85.png`;
    } else if (theme === 'dark') {
      imgUrl = `${baseUrl}/grey40.png`;
    } else if (hover) {
      imgUrl = `${baseUrl}/grey40.png`;
    } else {
      imgUrl = `${baseUrl}/grey55.png`;
  ...
  render() {
    ...
    return react_default.a.createElement(tiles_Tile, {
      ...
      className: `quick-settings ${theme}`
    }, react_default.a.createElement("div", {
      className: "quick-settings-header"
    }, `${optionDisplay ? `${optionDisplay}` : `${t('QuickSettings')}`}`), react_default.a.createElement("div", {
      className: "quick-settings-options"
    }, this.generateSettings())));
  }

}

QuickSettings_QuickSettings.propTypes = {
  saved: prop_types_default.a.bool.isRequired,
  hideFlag: prop_types_default.a.bool.isRequired,
  context: prop_types_default.a.object.isRequired,
  history: prop_types_default.a.object.isRequired,
...
/* harmony default export */ var tiles_QuickSettings = (react_router_dom_es_withRouter(hoc_withAppContext(QuickSettings_QuickSettings)));
// CONCATENATED MODULE: ./src/jsx/component/drawer/Drawer.jsx
...
class Drawer_Drawer extends react["Component"] {
  constructor(props) {
    super(props); // bindings
  ...
  composeTiles() {
    ...
    return tiles.map(tile => {
      switch (tile.name) {
        case 'RegionTile':
          return react_default.a.createElement(tiles_RegionTile, {
            key: tile.name,
            region: region,
            hideFlag: false,
            saved: tile.saved,
        ...
        case 'QuickConnect':
          return react_default.a.createElement(tiles_QuickConnect, {
            key: tile.name,
            mode: mode,
            region: region,
            hideFlag: false,
        ...
        case 'QuickSettings':
          return react_default.a.createElement(tiles_QuickSettings, {
            key: tile.name,
            hideFlag: false,
            saved: tile.saved,
            toggleTileSaved: toggleTileSaved
        ...
        case 'Subscription':
          return react_default.a.createElement(tiles_Subscription, {
            key: tile.name,
            hideFlag: false,
            saved: tile.saved,
            toggleTileSaved: toggleTileSaved
        ...
        case 'BypassRules':
          return react_default.a.createElement(tiles_BypassRules, {
            key: tile.name,
            hideFlag: false,
            saved: tile.saved,
            toggleTileSaved: toggleTileSaved
  ...
  render() {
    ...
    if (open) {
      drawerStyle = {
        maxHeight: `${tiles.length * 85 + 30}px`
      };
    }
    ...
    return react_default.a.createElement("div", {
      ...
      className: "drawer-renderable",
      style: drawerStyle
    }, react_default.a.createElement("div", {
      className: "drawer-header"
    }, t('DefaultDisplay')), react_default.a.createElement("div", {
...
Drawer_Drawer.propTypes = {
  ...
  mode: prop_types_default.a.string.isRequired,
  tiles: prop_types_default.a.array.isRequired,
  context: prop_types_default.a.object.isRequired,
  autoLoading: prop_types_default.a.bool.isRequired,
  connection: prop_types_default.a.string.isRequired,
  onQuickConnect: prop_types_default.a.func.isRequired,
...
/* harmony default export */ var drawer_Drawer = (hoc_withAppContext(Drawer_Drawer));
// CONCATENATED MODULE: ./src/jsx/component/drawer/DrawerOutlet.jsx
...
class DrawerOutlet_DrawerOutlet extends react["Component"] {
  constructor(props) {
    super(props); // bindings
  ...
  render() {
    ...
    return react_default.a.createElement("div", {
      className: `drawer-outlet ${theme}`
    }, this.composeTiles());
  }

}

DrawerOutlet_DrawerOutlet.propTypes = {
  region: prop_types_default.a.object,
  tiles: prop_types_default.a.array.isRequired,
  context: prop_types_default.a.object.isRequired,
  drawerOpen: prop_types_default.a.bool.isRequired,
  autoLoading: prop_types_default.a.bool.isRequired,
  toggleTileSaved: prop_types_default.a.func.isRequired,
  onQuickConnect: prop_types_default.a.func.isRequired,
  mode: prop_types_default.a.string.isRequired,
...
DrawerOutlet_DrawerOutlet.defaultProps = {
  region: undefined
};
/* harmony default export */ var drawer_DrawerOutlet = (hoc_withAppContext(DrawerOutlet_DrawerOutlet));
// CONCATENATED MODULE: ./src/jsx/component/SettingsDisclaimer.jsx
...
const SettingsDisclaimer = ({
  ...
  return react_default.a.createElement("div", {
    className: `settings-disclaimer tile ${theme}`
  }, react_default.a.createElement("span", {
    className: "disclaimer-contents"
  }, t('PersistentSettingsDisclaimer')), react_default.a.createElement("div", {
...
/* harmony default export */ var component_SettingsDisclaimer = (SettingsDisclaimer);
// CONCATENATED MODULE: ./src/jsx/component/drawer/DrawerHandle.jsx



const DrawerHandle_Drawer = props => {
  const {
    theme,
    open,
    onToggleDrawer
  ...
  return react_default.a.createElement("div", {
    ...
    className: `drawer-handle-arrow ${open ? 'open' : ''}`
  }));
};

DrawerHandle_Drawer.propTypes = {
  open: prop_types_default.a.bool.isRequired,
  theme: prop_types_default.a.string.isRequired,
  onToggleDrawer: prop_types_default.a.func.isRequired
};
/* harmony default export */ var DrawerHandle = (DrawerHandle_Drawer);
// CONCATENATED MODULE: ./src/jsx/pages/AuthenticatedPage.jsx
...
class AuthenticatedPage_AuthenticatedPage extends react["Component"] {
  constructor(props) {
    super(props); // properties
    ...
    this.state = {
      ...
      settingsDisclaimerDismissed: this.getSettingsDisclaimerDismissed()
    }; // bindings
    ...
    this.dismissSettingsDisclaimer = this.dismissSettingsDisclaimer.bind(this); // default tiles
  ...
  onQuickConnect(regionId) {
    ...
    return this.proxy.enable().then(proxy => {
  ...
  getSettingsDisclaimerDismissed() {
    const {
      app: {
        util: {
          storage
  ...
  dismissSettingsDisclaimer() {
    ...
    storage.setItem(SETTINGS_DISCLAIMER_KEY, String(true));
    this.setState(() => {
      return {
        settingsDisclaimerDismissed: true
      };
    });
  }
  ...
  render() {
    ...
    let connection = enabled ? 'connected' : 'disconnected'; // handle proxy errors
    ...
    return react_default.a.createElement("div", {
      ...
      className: `connection ${theme}`
    }, react_default.a.createElement("div", {
      className: `switch-container ${drawerOpen ? 'closed' : ''}`
    }, react_default.a.createElement(component_Switch, {
      mode: mode,
      theme: theme,
      connection: connection,
      onToggleConnection: this.onToggleConnection
    })), !settingsDisclaimerDismissed && react_default.a.createElement(component_SettingsDisclaimer, {
      onDismiss: this.dismissSettingsDisclaimer,
      theme: theme
    }), react_default.a.createElement("div", {
      className: "authenticated-tiles"
    }, react_default.a.createElement(drawer_DrawerOutlet, {
      region: region,
      tiles: savedTiles,
      drawerOpen: drawerOpen,
      autoLoading: autoLoading,
      ...
      mode: mode,
      connection: connection
    }), react_default.a.createElement(drawer_Drawer, {
      region: region,
      open: drawerOpen,
      tiles: unsavedTiles,
      autoLoading: autoLoading,
      ...
      mode: mode,
      connection: connection
    }))), react_default.a.createElement(DrawerHandle, {
      theme: theme,
      open: drawerOpen,
...
AuthenticatedPage_AuthenticatedPage.propTypes = {
  context: prop_types_default.a.object.isRequired
};
/* harmony default export */ var pages_AuthenticatedPage = (hoc_withAppContext(AuthenticatedPage_AuthenticatedPage));
// CONCATENATED MODULE: ./src/jsx/pages/UncontrollablePage.jsx





class UncontrollablePage_UncontrollablePage extends react["Component"] {
  constructor(props) {
    super(props); // Properties

    this.app = props.context.app;
    this.settings = this.app.util.settings;
    this.extensionsUrl = 'chrome://extensions'; // Bindings
  ...
  render() {
    ...
    return react_default.a.createElement("div", {
      className: `uncontrollable-page row ${theme}`
    }, react_default.a.createElement(component_CompanyLogo, {
      hideLinks: true
    }), react_default.a.createElement("div", {
      className: "warningicon"
      ...
      className: "warningtext"
    }, t('CannotUsePIAMessage')), react_default.a.createElement("p", {
      className: "btn-center"
    }, react_default.a.createElement("button", {
      type: "button",
      className: "btn",
...
UncontrollablePage_UncontrollablePage.propTypes = {
  context: prop_types_default.a.object.isRequired
};
/* harmony default export */ var pages_UncontrollablePage = (hoc_withAppContext(UncontrollablePage_UncontrollablePage));
// CONCATENATED MODULE: ./src/jsx/component/LabelledInput.jsx
...
function LabelledInput(props) {
  ...
  return react_default.a.createElement("label", {
    className: className,
    htmlFor: inputID
  }, text, react_default.a.createElement("input", {
    name: name,
    onChange: onChange,
    id: inputID,
...
/* harmony default export */ var component_LabelledInput = (LabelledInput);
// CONCATENATED MODULE: ./src/jsx/pages/RegionOverridePage.jsx





class RegionOverridePage_RegionOverridePage extends react["Component"] {
  constructor(props) {
    super(props); // bindings
    ...
    this.state = {
      name: '',
      host: '',
      port: RegionOverridePage_RegionOverridePage.defaultPort,
  ...
  async onRemove(ev) {
    ...
    this.refreshRegions(); // if proxy was connected to this region, refresh proxy
  ...
  render() {
    ...
    return react_default.a.createElement("div", {
      id: "region-override-template"
    }, react_default.a.createElement("div", {
      className: "override-heading"
    }, react_default.a.createElement("h1", {
      className: "override-title"
    }, "Region Override"), react_default.a.createElement("span", {
      className: "disclaimer"
    }, "This page is intended for development and debugging purposes")), react_default.a.createElement("div", {
      className: "add-region"
    }, react_default.a.createElement(component_LabelledInput, {
      name: "name",
      text: "Name:",
    ...
    }, "Add")), react_default.a.createElement("div", {
      className: "error"
    }, react_default.a.createElement("span", {
      className: "error-message"
    }, errorMessage)), !!overrideRegions.length && react_default.a.createElement("table", {
      className: "override-regions"
    }, react_default.a.createElement("tbody", null, react_default.a.createElement("tr", null, react_default.a.createElement("th", {
      className: "name-header"
    }, "Name"), react_default.a.createElement("th", {
      className: "host-header"
    }, "Host"), react_default.a.createElement("th", {
      className: "port-header"
    }, "Port"), react_default.a.createElement("th", {
      className: "select-header"
    }, "Select"), react_default.a.createElement("th", {
      className: "remove-header"
    }, "Remove")), overrideRegions.map(region => {
      return react_default.a.createElement("tr", {
        key: region.id,
        className: "override-region"
      }, react_default.a.createElement("td", {
        className: "name"
      }, region.name), react_default.a.createElement("td", {
        className: "host"
      }, region.host), react_default.a.createElement("td", {
        className: "port"
      }, region.port), react_default.a.createElement("td", {
        className: "select"
      }, react_default.a.createElement("button", {
        type: "button",
        name: region.id,
...
RegionOverridePage_RegionOverridePage.defaultPort = 443;
RegionOverridePage_RegionOverridePage.propTypes = {
  context: prop_types_default.a.object.isRequired
};
/* harmony default export */ var pages_RegionOverridePage = (hoc_withAppContext(RegionOverridePage_RegionOverridePage));
...
// CONCATENATED MODULE: ./src/jsx/routes/PrivateRoute.jsx
...
class PrivateRoute_PrivateRoute extends react["Component"] {
  constructor(props) {
    super(props);
    this.app = props.context.app;
  ...
  renderProps(props) {
    ...
    if (isLoggedIn) {
      ...
      return react_default.a.createElement(ChildComponent, props);
    } // disable proxy if not authenticated


    this.app.proxy.disable(); // redirect to login page
    ...
    return react_default.a.createElement(react_router_dom_es_Redirect, {
      to: loginComponent
    });
  }
  ...
  render() {
    ...
    return react_default.a.createElement(react_router_dom_es_Route, PrivateRoute_extends({}, modifiedProps, {
...
/* harmony default export */ var routes_PrivateRoute = (hoc_withAppContext(PrivateRoute_PrivateRoute));
// CONCATENATED MODULE: ./src/jsx/routes/index.jsx
...
const Routes = () => {
  return react_default.a.createElement(react_router_dom_es_Switch, null, react_default.a.createElement(routes_PrivateRoute, {
    path: Path.authenticated,
    exact: true,
    component: pages_AuthenticatedPage
  }), react_default.a.createElement(react_router_dom_es_Route, {
    path: Path.login,
    component: pages_LoginPage
  }), react_default.a.createElement(react_router_dom_es_Route, {
    path: Path.upgrade,
    component: pages_UpgradePage
  }), react_default.a.createElement(react_router_dom_es_Route, {
    path: Path.debugLog,
    component: DebugLogPage
  }), react_default.a.createElement(react_router_dom_es_Route, {
    path: Path.uncontrollable,
    component: pages_UncontrollablePage
  }), react_default.a.createElement(react_router_dom_es_Route, {
    path: Path.regionOverride,
    component: pages_RegionOverridePage
  }), react_default.a.createElement(routes_PrivateRoute, {
    path: Path.changeRegion,
    component: pages_ChangeRegionPage
  }), react_default.a.createElement(routes_PrivateRoute, {
    path: Path.settings,
    component: pages_SettingsPage
  }), react_default.a.createElement(routes_PrivateRoute, {
    path: Path.changelog,
    component: ChangeLogPage
  }), react_default.a.createElement(routes_PrivateRoute, {
    path: Path.bypassList,
    component: pages_BypassListPage
  }), react_default.a.createElement(react_router_dom_es_Route, {
    component: pages_LoginPage
  }));
};
...
// CONCATENATED MODULE: ./src/jsx/app/app.jsx
...
class app_App extends react["Component"] {
  constructor(props) {
    ...
    this.handleKeyDown = this.handleKeyDown.bind(this); // get app from background page

    this.app = chrome.extension.getBackgroundPage().app; // check if proxy is controllable

    this.uncontrollable = !this.app.proxy.isControllable();

    if (this.uncontrollable) {
      setTimeout(() => {
        this.history.push(Path.uncontrollable);
      }, 0);
    } // check for compatibility


    this.upgrade = !this.app.chromesettings.webrtc.blockable;

    if (this.upgrade) {
      setTimeout(() => {
        this.history.push(Path.upgrade);
      }, 0);
  ...
  render() {
    ...
    return react_default.a.createElement(AppProvider, {
      value: context
...
/* harmony default export */ var app = (react_router_dom_es_withRouter(app_App));
// EXTERNAL MODULE: ./src/js/eventhandler/onError.js
var onError = __webpack_require__(88);

// EXTERNAL MODULE: ./src/js/helpers/messaging.js
var messaging = __webpack_require__(84);

// CONCATENATED MODULE: ./src/js/helpers/checkBrowserVersion.js
...
function checkBrowserVersion(start, end) {
  ...
  const version = Number(versionStr); // validate version
...
/* harmony default export */ var helpers_checkBrowserVersion = (checkBrowserVersion);
// CONCATENATED MODULE: ./src/jsx/app/index.jsx
...
const {
  app: app_app
} = background; // setup i18n

Promise.resolve() // setup global bindings
.then(() => {
  window.debug = app_app.logger.debug;
  window.t = app_app.util.i18n.t;
  Object(onError["a" /* default */])(app_app, {
  ...
  if (helpers_checkBrowserVersion(67, 70)) {
...
.then(() => {
  react_dom_default.a.render(react_default.a.createElement(react_router_dom_es_MemoryRouter, null, react_default.a.createElement(app, null)), document.getElementById('page-content'));
}) // send frontend started message
.then(() => {
  return Object(messaging["d" /* sendMessage */])({
    target: messaging["a" /* Target */].ALL,
    type: messaging["b" /* Type */].FOREGROUND_OPEN
  });
}).catch(err => {
  debug(err);
});
